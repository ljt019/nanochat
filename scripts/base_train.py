"""Train model from scratch (base pretraining)."""
...
aspect_ratio = 64  # model_dim = depth * aspect_ratio (reduce for "deep" models, increase for "wide" models)
...
model_dim = (
    depth * aspect_ratio
)  # aspect ratio: default 64, lower = deeper/narrower, higher = wider/shallower
num_heads = max(
    1, (model_dim + 127) // 128
